...
function UpdatePassword() {
    ...
    const handleOnSubmit = (e) => {
        ...
        dispatch(resetPassword(password , confirmPassword, token , navigate)); // token -> jho mail send kiye usmai last part 
    }
  return (
    <div className='grid min-h-[calc(100vh-3.5rem)] place-items-center'>
            {
                ...
                (<div className='max-w-[500px] p-4 lg:p-8 '>
                    ...
                    <form onSubmit={handleOnSubmit}>
                        ...
                        (<Link to={"/login"}><button className='mt-6 w-full rounded-[8px] bg-yellow-200 py-[12px] px-[12px] font-medium text-richblack-900'>
                        Return to login
                        </button></Link>)
                        }
