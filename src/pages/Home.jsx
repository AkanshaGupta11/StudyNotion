  ...
  return (
    <div>
        ...
        <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between'>
           ...
           <div className='mx-3 my-12 shadow-blue-200 shadow-md w-[70%] relative'>
            <div className='grad2 -top-10 w-[800px] bg-white'></div>
        ...
        <div className = 'bg-pure-greys-5 text-richblack-700 '>
            <div className = 'homepage_bg lg:h-[450px] md:h-[310px] sm:h-[110px]'>
                <div className='w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-5 mx-auto'>
                <div className='lg:h-[350px] md:h-[50px] sm:h-[18px]' ></div>
        ...
        <div className='w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white'>
                ...
                <div className='relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white py-5'>
