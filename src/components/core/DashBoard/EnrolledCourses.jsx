        ...
        <div className='mx-auto w-11/12 max-w-[1000px] py-10'>
            ...
            {!enrolledCourses ? (
                ...
                <div className='my-8 text-richblack-5'>
                    ...
                    {/* Course Cards */}
                    <div className='flex flex-col border border-richblack-700 rounded-b-lg overflow-hidden'>
                        {enrolledCourses.map((course, i, arr) => (
                            <div
                                ...
                                key={i}
                            >
                                {/* Section 1: Image & Name - Clickable */}
                                <div
                                ...
                                {/* Section 3: Progress */}
                                <div className='flex w-[30%] flex-col gap-2 px-2 py-3'>
