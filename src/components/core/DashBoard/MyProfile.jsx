...
const MyProfile = () => {
    ...
    // navigate => used to go from one route to another
    const navigate = useNavigate();

    return (
        <div className='mx-auto w-full max-w-[1000px] py-10'>
            <div >
                <h1 className='mb-8 md:mb-14 text-3xl font-medium text-richblack-5'>
                    My Profile
                </h1>

                {/* section 1 */}
                <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-4 md:p-8 md:px-12'>
                    ...
                    <div className="hidden md:block">
                        <button className='text-black bg-yellow-300 rounded-md px-2 py-1' onClick={() => {
