...
import { Player } from "video-react" //used to display video 
...
export default function Upload({
  ...
  //if we are editing , user sees the preview video 
  ...
  const previewFile = (file) => {
    ...
    reader.readAsDataURL(file) // read binary file 
    reader.onloadend = () => { //when reading finishes 
      setPreviewSource(reader.result) //save the string url 
    }
  }
