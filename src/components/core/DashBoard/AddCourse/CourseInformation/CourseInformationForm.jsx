...
const CourseInformationForm = () => {
    //  getvalue  A function to get the current values from the form.
    const {
        register,
        handleSubmit,
        setValue,
...
//when u will edit this form , tho form should be filled with initial data 
//as u rendr fom , it is empty 
    ...
    const isFormUpdated = () => {
        const currentValues = getValues(); // et all current values from form
        //if user made any change in form in edit mode 
    ...
    // jaise save changes mai click -> edit course api call hogi 
    const onSubmit = async(data) => {
        ...
        try{
            ...
            console.log("addCourseDetails API failed", err);
        }
        if(result) {
            dispatch(setStep(2));
            dispatch(setCourse(result));
