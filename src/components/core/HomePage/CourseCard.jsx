...
const CourseCard = ({cardData,currentCard , setCurrentCard}) => {
    return (
        <div>
            <button className={`flex flex-col  w-[360px] h-[265.6px] p-5 gap-1  ${currentCard===cardData.heading? "bg-white text-richblack-700 shadow-[12px_12px_0px] shadow-[#FFD60A]":"bg-richblack-700 text-richblue-100"}`} onClick={()=>{setCurrentCard(cardData.heading)}}>
